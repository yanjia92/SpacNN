...
_lr_productions = [
  ...
  ('statement -> model_type_statement','statement',1,'p_statement','PRISMParser.py',123),
  ('statement -> const_value_statement','statement',1,'p_statement','PRISMParser.py',124),
  ('statement -> module_def_begin_statement','statement',1,'p_statement','PRISMParser.py',125),
  ('statement -> module_def_end_statement','statement',1,'p_statement','PRISMParser.py',126),
  ('statement -> module_var_def_statement','statement',1,'p_statement','PRISMParser.py',127),
  ('statement -> module_command_statement','statement',1,'p_statement','PRISMParser.py',128),
  ('statement -> formula_statement','statement',1,'p_statement','PRISMParser.py',129),
  ('statement -> label_statement','statement',1,'p_statement','PRISMParser.py',130),
  ('model_type_statement -> DTMC','model_type_statement',1,'p_model_type','PRISMParser.py',135),
  ('model_type_statement -> CTMC','model_type_statement',1,'p_model_type','PRISMParser.py',136),
  ('module_def_begin_statement -> MODULE NAME','module_def_begin_statement',2,'p_module_def_begin_statement','PRISMParser.py',143),
  ('module_def_end_statement -> ENDMODULE','module_def_end_statement',1,'p_module_def_end_statement','PRISMParser.py',148),
  ('const_value_statement -> CONST INT NAME ASSIGN NUM SEMICOLON','const_value_statement',6,'p_const_expression','PRISMParser.py',154),
  ('const_value_statement -> CONST DOUBLE NAME ASSIGN NUM SEMICOLON','const_value_statement',6,'p_const_expression','PRISMParser.py',155),
  ('const_value_statement -> CONST BOOL NAME ASSIGN NUM SEMICOLON','const_value_statement',6,'p_const_expression','PRISMParser.py',156),
  ('const_value_statement -> CONST INT NAME SEMICOLON','const_value_statement',4,'p_const_expression1','PRISMParser.py',165),
  ('const_value_statement -> CONST DOUBLE NAME SEMICOLON','const_value_statement',4,'p_const_expression1','PRISMParser.py',166),
  ('const_value_statement -> CONST BOOL NAME SEMICOLON','const_value_statement',4,'p_const_expression1','PRISMParser.py',167),
  ('const_value_statement -> CONST INT NAME ASSIGN expr SEMICOLON','const_value_statement',6,'p_const_expression2','PRISMParser.py',176),
  ('const_value_statement -> CONST DOUBLE NAME ASSIGN expr SEMICOLON','const_value_statement',6,'p_const_expression2','PRISMParser.py',177),
  ('const_value_statement -> CONST BOOL NAME ASSIGN expr SEMICOLON','const_value_statement',6,'p_const_expression2','PRISMParser.py',178),
  ('module_var_def_statement -> NAME COLON LB expr COMMA expr RB INIT NUM SEMICOLON','module_var_def_statement',10,'p_module_var_def_statement','PRISMParser.py',187),
  ('module_command_statement -> LB RB boolean_expression THEN updates SEMICOLON','module_command_statement',6,'p_module_command_statement','PRISMParser.py',199),
  ('updates -> updates ADD prob_update','updates',3,'p_updates','PRISMParser.py',203),
  ('updates -> prob_update','updates',1,'p_updates1','PRISMParser.py',207),
  ('prob_update -> DQ NAME DQ expr COLON actions','prob_update',6,'p_prob_update','PRISMParser.py',211),
  ('actions -> actions AND assignment','actions',3,'p_actions','PRISMParser.py',220),
  ...
  ('expr -> term','expr',1,'p_expr2','PRISMParser.py',273),
  ('term -> term MUL factor','term',3,'p_term','PRISMParser.py',281),
  ('term -> term DIV factor','term',3,'p_term','PRISMParser.py',282),
  ('term -> factor','term',1,'p_term1','PRISMParser.py',292),
  ('factor -> NUM','factor',1,'p_factor','PRISMParser.py',296),
  ('factor -> NAME','factor',1,'p_factor1','PRISMParser.py',305),
  ('factor -> NAME LP expr RP','factor',4,'p_factor2','PRISMParser.py',320),
  ('factor -> LP expr RP','factor',3,'p_factor3','PRISMParser.py',332),
  ('boolean_expression -> boolean_expression AND boolean_expression_unit','boolean_expression',3,'p_boolean_expression','PRISMParser.py',336),
  ('boolean_expression -> boolean_expression OR boolean_expression_unit','boolean_expression',3,'p_boolean_expression','PRISMParser.py',337),
  ('boolean_expression -> boolean_expression_unit','boolean_expression',1,'p_boolean_expression','PRISMParser.py',338),
  ('boolean_expression_unit -> NAME GT NUM','boolean_expression_unit',3,'p_boolean_expression_unit','PRISMParser.py',359),
  ('boolean_expression_unit -> NAME LT NUM','boolean_expression_unit',3,'p_boolean_expression_unit','PRISMParser.py',360),
  ('boolean_expression_unit -> NAME GE NUM','boolean_expression_unit',3,'p_boolean_expression_unit','PRISMParser.py',361),
  ('boolean_expression_unit -> NAME LE NUM','boolean_expression_unit',3,'p_boolean_expression_unit','PRISMParser.py',362),
  ('boolean_expression_unit -> NAME EQ NUM','boolean_expression_unit',3,'p_boolean_expression_unit','PRISMParser.py',363),
  ('boolean_expression_unit -> NAME NEQ NUM','boolean_expression_unit',3,'p_boolean_expression_unit','PRISMParser.py',364),
  ('boolean_expression_unit -> NAME GT expr','boolean_expression_unit',3,'p_boolean_expression_unit1','PRISMParser.py',383),
  ('boolean_expression_unit -> NAME LT expr','boolean_expression_unit',3,'p_boolean_expression_unit1','PRISMParser.py',384),
  ('boolean_expression_unit -> NAME GE expr','boolean_expression_unit',3,'p_boolean_expression_unit1','PRISMParser.py',385),
  ('boolean_expression_unit -> NAME LE expr','boolean_expression_unit',3,'p_boolean_expression_unit1','PRISMParser.py',386),
  ('boolean_expression_unit -> NAME EQ expr','boolean_expression_unit',3,'p_boolean_expression_unit1','PRISMParser.py',387),
  ('boolean_expression_unit -> NAME NEQ expr','boolean_expression_unit',3,'p_boolean_expression_unit1','PRISMParser.py',388),
  ('formula_statement -> FORMULA NAME ASSIGN expr SEMICOLON','formula_statement',5,'p_formula_statement','PRISMParser.py',409),
  ('label_statement -> LABEL NAME ASSIGN boolean_expression SEMICOLON','label_statement',5,'p_label_statement','PRISMParser.py',416),
]
